...
const Sidebar = () => {
  ...
  const links = [
    ...
    { name: "Category", icon: <FaTags />, path: "/admin/category" },
    ...
    { name: "Activity Logs", icon: <FaClipboardList />, path: "/admin/activity-logs" },
    { name: "Damaged Items", icon: <FaExclamationTriangle />, path: "/admin/damaged-items" },
    { name: "Discounts", icon: <FaPercent />, path: "/admin/discounts" },
